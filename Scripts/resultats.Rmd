...
```{r comp-annees, fig.cap="Nombre de décès chez les 18-29 ans en 2018 et 2019 en fonction de la période et du sexe", fig.width=10, fig.height = 4}
...
```{r comp-annees-moy, fig.cap="Nombre moyen de décès journaliers chez les 18-29 ans en 2018 et 2019 en fonction de la période et du sexe", fig.width=10, fig.height = 4}
