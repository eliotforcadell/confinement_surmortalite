...
# √Çge au moment du d√©c√®s
deces[, age := interval(date_nais, date_dec) %/% years(1)]


# Dataframe Èvolution de la mortalitÈ sur diffÈrentes pÈriode
...
# seulement le premier mois pour calculer un taux de mortalitÈ par mois comparable.
...
#Taux de mortalitÈ pour 100 000 pour le mois du premier confinement chaque annÈes
#Homme
...
#Taux de mortalitÈ pour 100 000 pour le mois du deuxieme confinement chaque annÈes
#Homme
...
# Exportation de la base compl√®te
